...
\begin{tikzpicture}
  ...
  \node[data] (record-list) [above=2 of record] {
    \href{https://github.com/ipfs/specs/pull/7}{Record list} \\
  };
  ...
  \draw[use] (signature.east) to [out=90,in=-120] (record-list);
  \draw[use,bend left=10] (record-list) to (recordstore-value);
