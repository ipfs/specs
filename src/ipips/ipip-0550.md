...
adds one parameter, `PBNode field order`. The complete profile:
...
Only the last row is new; every other value matches `unixfs-v1-2025`.

When a profile does not define `PBNode field order`, it is `links-first`. All
