...
The handling of empty files, hidden files, unreadable files, symlinks, and symlink follows is defined by the [UnixFS](https://specs.ipfs.tech/unixfs/) spec.
...
To generate CIDs in compliance with this IPIP, implementations must support the parameters defined in the profiles and support the the set of named profiles. They MAY also support legacy profiles.
